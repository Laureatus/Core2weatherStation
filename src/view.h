...
lv_obj_t * add_label(const char * text, lv_coord_t x_ofs, lv_coord_t y_ofs, lv_align_t align = LV_ALIGN_IN_TOP_LEFT);
...
lv_obj_t * add_image(const void * src_img, lv_coord_t x_ofs, lv_coord_t y_ofs, lv_event_cb_t event_handler = NULL);
